...
var nanobyte = {
	...
	displayMessage : function(msg,t,b,h,w){
		...
		$('body').append('<div id="dialog'+i+'" class="dialog">'+msg+'</div>');
		this.formatDialog();
		if (!b) {
			var	b = {
				'Ok': function(){
	...
	showInlineMessage : function(msg){
		$('#messages').html(msg).fadeIn('slow').pause(10000).fadeOut('slow');
	},
...
var tb_pathToImage = "templates/Nanobyte/images/loading.gif";
